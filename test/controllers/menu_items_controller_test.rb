...
class MenuItemsControllerTest < ActionController::TestCase
  ...
  test "should create menu_item" do
    assert_difference('MenuItem.count') do
      post :create, menu_item: { description: @menu_item.description, img_url: @menu_item.img_url, name: @menu_item.name, price: @menu_item.price, section_id: @menu_item.section_id, views_count: @menu_item.views_count }
    end
  ...
  test "should update menu_item" do
    patch :update, id: @menu_item, menu_item: { description: @menu_item.description, img_url: @menu_item.img_url, name: @menu_item.name, price: @menu_item.price, section_id: @menu_item.section_id, views_count: @menu_item.views_count }
    assert_redirected_to menu_item_path(assigns(:menu_item))
  end
